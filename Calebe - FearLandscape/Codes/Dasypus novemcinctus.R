...
# Select the nine-banded armadillo data
Data = Data[,c("Site", "NightLight_5km", "Dasypus_novemcinctus_Day", "Dasypus_novemcinctus_Night")]
...
CData = CData[CData$Species == "Dasypus_novemcinctus",]
