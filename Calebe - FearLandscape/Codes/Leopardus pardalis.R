...
# Select the Ocelot data
Data = Data[,c("Site", "NightLight_3km", "Leopardus_pardalis_Day", "Leopardus_pardalis_Night")]
...
# Select the Agouti data
CData = CData[CData$Species == "Leopardus_pardalis",]
...
threshold = sort(unique(CData$NightLight_3K))
...
# Plotdata
less = CData$Hour.Dec[CData$NightLight_3K < threshold]
less = circular(less, type="angles",units="hours",template="clock24")

more = CData$Hour.Dec[CData$NightLight_3K > threshold]
