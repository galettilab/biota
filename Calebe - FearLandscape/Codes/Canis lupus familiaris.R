...
# Select the domestic dog data
Data = Data[,c("Site", "NightLight_5km", "Canis_lupus_familiaris_Day", "Canis_lupus_familiaris_Night")]
...
# Select the domestic dog data
CData = CData[CData$Species == "Canis_lupus_familiaris",]
