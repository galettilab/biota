...
# Select the white-eared opossum data
Data = Data[,c("Site", "NightLight_5km", "Didelphis_albiventris_Day", "Didelphis_albiventris_Night")]
...
# Select the white-eared opossum data
CData = CData[CData$Species == "Didelphis_albiventris",]
