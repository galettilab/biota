...
#Species: Guerlinguetus brasiliensis
...
# Select the Atlantic forest squirrel data
Data = Data[,c("Site", "NightLight_10km", "Guerlinguetus_brasiliensis_Day", "Guerlinguetus_brasiliensis_Night")]
...
# Select the Atlantic forest squirrel data
CData = CData[CData$Species == "Guerlinguetus_brasiliensis",]
...
threshold = sort(unique(CData$NightLight_10K))
...
# Plotdata
less = CData$Hour.Dec[CData$NightLight_10K < threshold]
less = circular(less, type="angles",units="hours",template="clock24")

more = CData$Hour.Dec[CData$NightLight_10K > threshold]
