...
# Select the Brazilian cottontail data
Data = Data[,c("Site", "NightLight_10km", "Sylvilagus_brasiliensis_Day", "Sylvilagus_brasiliensis_Night")]
...
# Select the Brazilian cottontail data
CData = CData[CData$Species == "Sylvilagus_brasiliensis",]
