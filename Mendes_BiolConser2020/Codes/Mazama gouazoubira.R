...
# Select the gray-brocket deer data
Data = Data[,c("Site", "NightLight_3km", "Mazama_gouazoubira_Day", "Mazama_gouazoubira_Night")]
...
# Select the gray-brocket deer data
CData = CData[CData$Species == "Mazama_gouazoubira",]
